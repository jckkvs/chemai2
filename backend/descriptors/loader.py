        ...
        for param_name, param in sig.parameters.items():
            ...
            if annotation == inspect.Parameter.empty:
                if param.default != inspect.Parameter.empty:
                    ...
                    param_info["type"] = "string"
            elif annotation == int: param_info["type"] = "integer"
            elif annotation == float: param_info["type"] = "number"
            elif annotation == bool: param_info["type"] = "boolean"
            elif annotation == str: param_info["type"] = "string"
            else:
                ...
                if orig == list or orig == List:
                    ...
                    try:
                        ...
                        param_info["items"] = {"type": "string" if item_type == str else "number"}
                    except IndexError:
