...
_RECOMMENDATION_DATA = [
    ...
    TargetRecommendations(
        ...
        descriptors=[
            ...
            DescriptorInfo("HBD_Count", "RDKit", "水素結合供与体数（強力な分子間ネットワーク）", "RDKit Descriptors", "極性・官能基系"),
            DescriptorInfo("HBA_Count", "RDKit", "水素結合受容体数", "RDKit Descriptors", "極性・官能基系"),
        ]
    ),
    TargetRecommendations(
    ...
    TargetRecommendations(
        ...
        descriptors=[
            ...
            DescriptorInfo("NumRings", "RDKit", "環の数（主鎖の硬さに比例）", "Bicerano (2002)", "トポロジー系"),
            DescriptorInfo("DipoleMoment", "XTB", "双極子モーメント（強い分子間力）", "GFN2-xTB", "極性・官能基系"),
            DescriptorInfo("HBD_Count", "RDKit", "水素結合供与体数", "RDKit", "極性・官能基系"),
        ]
    ),
    TargetRecommendations(
    ...
    TargetRecommendations(
        ...
        category="環境・安全性",
        descriptors=[
            DescriptorInfo("LogP", "RDKit", "オクタノール/水分配係数（生体バリア透過性）", "Lipinski's Rule of Five", "熱力学・相互作用系"),
            ...
            DescriptorInfo("HBA_Count", "RDKit", "水素結合受容体数", "Rule of Five", "極性・官能基系"),
            DescriptorInfo("HBD_Count", "RDKit", "水素結合供与体数", "Rule of Five", "極性・官能基系"),
    ...
    TargetRecommendations(
        ...
        descriptors=[
            ...
            DescriptorInfo("HBD_Count", "RDKit", "水素結合供与体", "Dielectric behavior of H-bond networks", "極性・官能基系"),
    ...
    TargetRecommendations(
        ...
        descriptors=[
            ...
            DescriptorInfo("LogP", "RDKit", "脂溶性（吸水＝水分子による巨大な誘電損失を防ぐ指標）", "Dielectric properties of polymers", "熱力学・相互作用系"),
    ...
    TargetRecommendations(
        ...
        category="環境・安全性",
        descriptors=[
            DescriptorInfo("LogP", "RDKit", "脂溶性（高いほど耐湿性が高い）", "Lipinski / ADMET", "熱力学・相互作用系"),
            DescriptorInfo("TPSA", "RDKit", "極性表面積（小さいほど耐湿性が高い）", "Ertl et al. (2000)", "極性・官能基系"),
            DescriptorInfo("HBD_Count", "RDKit", "水素結合供与体数（水分子を捕捉）", "Water absorption theory", "極性・官能基系"),
            DescriptorInfo("HBA_Count", "RDKit", "水素結合受容体数", "Water absorption theory", "極性・官能基系"),
    ...
    TargetRecommendations(
        ...
        descriptors=[
            ...
            DescriptorInfo("LogP", "RDKit", "オクタノール/水分配係数", "RDKit", "熱力学・相互作用系"),
            DescriptorInfo("TPSA", "RDKit", "極性表面積", "RDKit", "極性・官能基系"),
