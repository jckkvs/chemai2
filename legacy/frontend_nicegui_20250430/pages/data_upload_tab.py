...
class DataUploadPage:
    ...
    def __init__(self, llm_config, automl_page=None, viz_page=None, navigate_to_automl=None, navigate_to_interview=None):
        self.llm_config = llm_config
        self.automl_page = automl_page
        self.viz_page = viz_page
        self._navigate_to_automl_cb = navigate_to_automl
        self._navigate_to_interview_cb = navigate_to_interview
        self._interview_page = None
        ...
        with ui.column().classes('w-full max-w-6xl mx-auto p-4'):
            ...
            with self._quality_card:
                ...
                with ui.row().classes('mt-4 gap-4'):
                    ...
                    ui.button('🧠 LLMヒアリングで解析へ', on_click=self._navigate_to_interview, color='primary').props('size=lg')
                    ui.button('📊 データで直接解析', on_click=self._navigate_to_automl, color='primary').props('outline')
